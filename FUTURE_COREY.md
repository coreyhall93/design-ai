...
- `RESEARCH-AUTOMATTIC-BRANDS.md` — detailed findings, internal research sources (via context-a8c), limitations, and prioritized next steps/polish roadmap for the personal Automattic brand additions (automattic, wordpress-*, woocommerce, jetpack). Read this when you have time to come back.
